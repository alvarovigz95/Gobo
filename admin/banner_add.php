<?php 
	...
	if(isset($_FILES['banner_imagen'])){
		...
		$imagen = $_FILES['banner_imagen']['name'];
		
		move_uploaded_file($_FILES['banner_imagen']['tmp_name'],"../upload/banner/".$imagen);
		
		
	
		$estado = number_format($_POST['banner_status']);

		$sql = "INSERT INTO banner(banner_imagen,banner_status)
...
<body>
	...
	<div class="col-md-9">
		...
		<a href="banner.php" class="btn btn-primary pull-right"><i class="fa fa-arrow-left"></i> Volver</a>
		<br><br>
		...
		<form action="" method="post" enctype="multipart/form-data">
			<div class="form-group pull-left col-xs-12">
				...
				<div class="col-md-9">
					<input type="file" class="form-control" name="banner_imagen" id="banner_imagen">
				</div>
			</div>
